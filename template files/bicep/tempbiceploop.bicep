...
var appnames = ['TestappK1', 'TestappK2', 'TestappK3', 'TestappK4', 'TestappK5']

  // loop body


resource testloopappservice 'Microsoft.Web/sites@2022-09-01' = [for(appname, index) in appnames: {
  name: appname
  kind: 'app'
  location: 'East US'
  properties: {
